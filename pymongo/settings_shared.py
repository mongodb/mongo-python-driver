...
_PoolClassType = TypeVar("_PoolClassType")
_MonitorClassType = TypeVar("_MonitorClassType")


class _BaseTopologySettings(Generic[_PoolClassType, _MonitorClassType]):
    def __init__(
        self,
        pool_class: _PoolClassType,
        monitor_class: _MonitorClassType,
        ...
        self._pool_class: _PoolClassType = pool_class
        self._monitor_class: _MonitorClassType = monitor_class
        ...
        # test suite.
        self._stack = "".join(traceback.format_stack()[:-3])
    ...
    @property
    def pool_class(self) -> _PoolClassType:
    ...
    @property
    def monitor_class(self) -> _MonitorClassType:
