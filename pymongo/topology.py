...
class Topology:
    ...
    def on_change(self, server_description: ServerDescription, reset_pool: bool = False):
    ...
    def data_bearing_servers(self) -> List[Server]:
    ...
    def pop_all_sessions(self) -> None:
