...
class ClientSession:
    ...
    def _finish_transaction_with_retry(self, command_name: str) -> Mapping[str, Any]:
        ...
        def func(
            session: ClientSession, sock_info: SocketInfo, retryable: bool
        ) -> Mapping[str, Any]:
            return self._finish_transaction(sock_info, command_name)

        return self._client._retry_internal(True, func, self, None)

    def _finish_transaction(self, sock_info: SocketInfo, command_name: str) -> Mapping[str, Any]:
