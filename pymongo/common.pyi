...
def validate_document_class(option: str, value: Any) -> Union[collections.MutableMapping, collections.Mapping]: ...
...
def get_validated_options(options: Mapping[str, Any], warn: bool = True) -> Dict[str, Any]: ...
