...
class Cursor(object):
    ...
    def add_option(self, mask: int) -> _Cursor:
    ...
    def max_scan(self, max_scan: Optional[int]) -> _Cursor:
    ...
    def hint(self, index: Optional[_Hint]) -> _Cursor:
