...
# Python versions not yet provisioned by the Evergreen toolchain.  Tasks that
# require a toolchain-provided artifact, such as mod_wsgi, must skip these;
# everything else fetches them from python-build-standalone via
# fetch-python.sh.  Drop an entry once the toolchain provides the version.
NON_TOOLCHAIN_VERSIONS = {"3.15", "3.15t"}
