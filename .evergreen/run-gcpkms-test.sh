...
GCPKMS_CMD="SUCCESS=true TEST_FLE_GCP_AUTO=1 LIBMONGOCRYPT_URL=$LIBMONGOCRYPT_URL ./.evergreen/scripts/setup-tests.sh" $DRIVERS_TOOLS/.evergreen/csfle/gcpkms/run-command.sh
