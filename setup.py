...
class doc(Command):
    ...
    def run(self):
        ...
        if sys.version_info[0] >= 3:
            ...
            _u_literal_re = re.compile(r"(\W|^)(?<![\'\"])[uU]([rR]?[\'\"])", re.UNICODE)
            ...
            _b_literal_re = re.compile(r"(\W|^)(?<![\'\"])[bB]([rR]?[\'\"])", re.UNICODE)
            ...
            class _StringPrefixFixer(_OutputChecker):
                def check_output(self, want, got, optionflags):
                    ...
                    return super(_StringPrefixFixer, self).check_output(want, got, optionflags)
