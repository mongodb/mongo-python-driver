...
.. automodule:: pymongo.collection
   ...
   .. autoclass:: pymongo.collection.Collection(database, name[, options=None[, create=False[, **kwargs]]])
      ...
      .. automethod:: drop
      .. automethod:: find([spec=None[, fields=None[, skip=0[, limit=0[, timeout=True[, snapshot=False[, tailable=False[, sort=None[, max_scan=None[, as_class=None[, slave_okay=False[, await_data=False[, partial=False[, manipulate=True[, read_preference=SECONDARY[, **kwargs]]]]]]]]]]]]]]]])
