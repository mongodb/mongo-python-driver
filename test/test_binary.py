...
class TestUuidSpecImplicitCoding(IntegrationTest):
    ...
    def test_decoding_1(self):
        ...
        binary_value = Binary.from_uuid(self.uuid, UuidRepresentation.PYTHON_LEGACY)
        self._test_decoding("javaLegacy", UuidRepresentation.JAVA_LEGACY, self.uuid, self.uuid)
        self._test_decoding("csharpLegacy", UuidRepresentation.CSHARP_LEGACY, self.uuid, self.uuid)
        self._test_decoding("pythonLegacy", UuidRepresentation.PYTHON_LEGACY, self.uuid, self.uuid)
    ...
    def test_decoding_2(self):
        ...
        self._test_decoding(
            ...
            UuidRepresentation.PYTHON_LEGACY,
            self.uuid,
            binary_value.as_uuid(UuidRepresentation.PYTHON_LEGACY),
        )
