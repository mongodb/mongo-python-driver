...
from bson.py3compat import abc, iteritems, string_type, text_type
from bson.son import SON
from gridfs import GridFSBucket
from pymongo import client_session, helpers, operations
...
class SpecRunner(IntegrationTest):
    ...
    def run_operation(self, sessions, collection, operation):
        ...
        if object_name == "gridfsbucket":
            ...
            obj = GridFSBucket(database, bucket_name=collection.name, disable_md5=True)
        else:
            objects = {
