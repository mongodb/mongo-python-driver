...
class TestPyMongoProtocolTimeout(UnitTest):
    if not _IS_SYNC:
...
class TestPyMongoProtocolProcessHeader(UnitTest):
    if not _IS_SYNC:
...
class TestPyMongoProtocolProcessCompressionHeader(UnitTest):
    if not _IS_SYNC:
...
class TestPyMongoProtocolGetBuffer(UnitTest):
    if not _IS_SYNC:
...
class TestPyMongoProtocolBufferUpdated(UnitTest):
    if not _IS_SYNC:
...
class TestPyMongoProtocolClose(UnitTest):
    if not _IS_SYNC:
