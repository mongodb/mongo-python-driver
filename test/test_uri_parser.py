...
from bson.py3compat import _unicode, string_type
...
class TestURI(unittest.TestCase):
    ...
    def test_split_options(self):
        ...
        with warnings.catch_warnings():
            ...
            self.assertRaises(Warning, split_options, "ssl_match_hostname=foo", warn=True)
    ...
    def test_parse_ssl_paths(self):
        ...
        self.assertEqual(
            ...
            parse_uri(
                "mongodb://jesse:foo%2Fbar@%2FMongoDB.sock/?ssl_certfile=/a/b", validate=False
            ),
        )
    ...
    def test_normalize_options(self):
        ...
        uri = (
            "mongodb://example.com/?tls=true&appname=myapp&maxPoolSize=10&" "fsync=true&wtimeout=10"
        )
        res = {"ssl": True, "appname": "myapp", "maxpoolsize": 10, "fsync": True, "wtimeoutms": 10}
        self.assertEqual(res, parse_uri(uri)["options"])
