...
class TestGridfs(IntegrationTest):
    ...
    def test_upload_from_stream(self):
        oid = self.fs.upload_from_stream("test_file", StringIO(b"hello world"), chunk_size_bytes=1)
    ...
    def test_upload_from_stream_with_id(self):
        ...
        self.fs.upload_from_stream_with_id(
            oid, "test_file_custom_id", StringIO(b"custom id"), chunk_size_bytes=1
        )
...
class TestGridfsBucketReplicaSet(TestReplicaSetClientBase):
    ...
    def test_gridfs_secondary(self):
        ...
        self.assertRaises(ConnectionFailure, gfs.upload_from_stream, "test_filename", b"foo")
    ...
    def test_gridfs_secondary_lazy(self):
        ...
        self.assertRaises(ConnectionFailure, gfs.upload_from_stream, "test_filename", b"data")
