...
class TestGridfs(IntegrationTest):
    ...
    @patch("gridfs._sync.grid_file._UPLOAD_BUFFER_CHUNKS", 3)
    ...
    @patch("gridfs._sync.grid_file._UPLOAD_BUFFER_CHUNKS", 10)
    ...
    @patch("gridfs._sync.grid_file._UPLOAD_BUFFER_SIZE", 5)
    def test_abort(self):
