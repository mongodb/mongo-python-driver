...
from pymongo.pool import PoolOptions, _CancellationContext, _PoolGeneration
...
class ServerAndTopologyEventListener(ServerEventListener, monitoring.TopologyListener):
...
def _mongo_client(host, port, authenticate=True, directConnection=False, **kwargs):
