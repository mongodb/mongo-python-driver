...
class TestAsyncClientUnitTest:
    ...
    async def async_client(self, async_client_context_fixture) -> AsyncMongoClient:
    ...
    async def test_get_default_database(self, async_client_context_fixture):
    ...
    async def test_get_default_database_error(self, async_client_context_fixture):
    ...
    async def test_get_default_database_with_authsource(self, async_client_context_fixture):
    ...
    async def test_get_database_default(self, async_client_context_fixture):
        c = await async_rs_or_single_client(async_client_context_fixture,
            "mongodb://%s:%d/foo"
            % (await async_client_context_fixture.host, await async_client_context_fixture.port),
            connect=False,
    ...
    async def test_get_database_default_error(self, async_client_context_fixture):
        # URI with no database.
        c = await async_rs_or_single_client(async_client_context_fixture,
            "mongodb://%s:%d/" % (await async_client_context_fixture.host, await async_client_context_fixture.port),
            connect=False,
    ...
    async def test_get_database_default_with_authsource(self, async_client_context_fixture):
        # Ensure we distinguish database name from authSource.
        uri = "mongodb://%s:%d/foo?authSource=src" % (
            await async_client_context_fixture.host,
            await async_client_context_fixture.port,
    ...
    async def test_primary_read_pref_with_tags(self, async_client_context_fixture):
    ...
    async def test_read_preference(self, async_client_context_fixture):
        c = await async_rs_or_single_client(async_client_context_fixture,
    ...
    async def test_uri_codec_options(self, async_client_context_fixture):
        uuid_representation_label = "javaLegacy"
        unicode_decode_error_handler = "ignore"
    ...
    async def test_connection_timeout_ms_propagates_to_DNS_resolver(self, patch_resolver):
    ...
    async def test_detected_environment_warning(self, caplog):
        normal_hosts = [
            "host.cosmos.azure.com",
            "host.docdb.amazonaws.com",
            "host.docdb-elastic.amazonaws.com",
