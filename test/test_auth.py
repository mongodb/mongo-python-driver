...
class TestSCRAM(IntegrationTest):
    ...
    def test_scram(self):
        ...
        if HAVE_STRINGPREP:
            ...
            self.assertTrue(client.testscram.authenticate("\u2168", "\u2163"))
            client.testscram.command("dbstats")
            client.testscram.logout()
            self.assertTrue(
                client.testscram.authenticate("\u2168", "\u2163", mechanism="SCRAM-SHA-256")
            )
            client.testscram.command("dbstats")
            client.testscram.logout()
            self.assertTrue(client.testscram.authenticate("\u2168", "IV"))
            client.testscram.command("dbstats")
            client.testscram.logout()

            self.assertTrue(client.testscram.authenticate("IX", "I\u00ADX"))
            client.testscram.command("dbstats")
            client.testscram.logout()
            self.assertTrue(
                client.testscram.authenticate("IX", "I\u00ADX", mechanism="SCRAM-SHA-256")
            )
            client.testscram.command("dbstats")
            client.testscram.logout()
            self.assertTrue(client.testscram.authenticate("IX", "IX"))
            client.testscram.command("dbstats")
            client.testscram.logout()
