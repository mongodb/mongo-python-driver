...
class TestBSON(unittest.TestCase):
    ...
    def test_basic_encode(self):
        ...
        self.assertEqual(BSON.encode({"test": Binary(b"test")}),
    ...
    def test_overflow(self):
        ...
        self.assertRaises(OverflowError, BSON.encode, {"x": 9223372036854775808})

        self.assert_(BSON.encode({"x": -9223372036854775808}))
        self.assertRaises(OverflowError, BSON.encode, {"x": -9223372036854775809})
