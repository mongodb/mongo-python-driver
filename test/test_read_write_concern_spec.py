    ...
    def run_test(self):
        ...
        if "writeConcern" in test_case:
            ...
            if not valid:
                ...
                self.assertEqual(concern.document, test_case["writeConcernDocument"])
                self.assertEqual(concern.acknowledged, test_case["isAcknowledged"])
                self.assertEqual(concern.is_server_default, test_case["isServerDefault"])
        if "readConcern" in test_case:
            ...
            self.assertEqual(not bool(concern.level), test_case["isServerDefault"])
