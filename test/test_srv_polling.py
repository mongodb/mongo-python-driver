...
class TestSrvPolling(PyMongoTestCase):
    ...
    def test_rescan_skips_only_the_hosts_that_fail_verification(self):
        ...
        for validator in (rejecting, raising):
            with self.subTest(validator=validator.__name__):
                resolver = pymongo.synchronous.srv_resolver._SrvResolver(
                ...
                with patch("dns.resolver.resolve", return_value=answer):
                    nodes, _ = resolver.get_hosts_and_min_ttl()
