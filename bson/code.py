...
class Code(str):
    ...
    _type_marker = 13
    __scope: Union[_Mapping[str, Any], None]

    def __new__(cls: Type[_Code], code: Union[str, _Code], scope: Optional[_Mapping[str, Any]] = None, **kwargs: Any) -> _Code:
    ...
    @property
    def scope(self) -> Optional[_Mapping[str, Any]]:
