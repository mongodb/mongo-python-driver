...
class _BaseCodecOptions(NamedTuple):
    ...
    def __new__(  # type:ignore[misc]
        ...
        try:
            ...
            if hasattr(doc_class, "__origin__"):
                origin = doc_class.__origin__  # type:ignore[union-attr]
                is_mapping = issubclass(origin, _MutableMapping)
    ...
    def with_options(self, **kwargs: Any) -> _BaseCodecOptions:
