...
batch_size = 100
small = {}
medium = {"integer": 5, "number": 5.05, "boolean": False, "array": ["test", "benchmark"]}
...
large = {
    ...
    "page_structure": {"counted_tags": 3450, "no_of_js_attached": 10, "no_of_images": 6},
    "harvested_words": [
        "10gen",
        "web",
        "open",
...
def main():
    ...
    timed(
        "batch insert (medium, no index)", insert_batch, [db, "medium_bulk", medium], setup_insert
    )
